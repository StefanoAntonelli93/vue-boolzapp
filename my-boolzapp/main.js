...
createApp({
  ...
  methods: {
    ...
    // creo metodo listAvatar per cercare avatar
    listAvatar() {
       
        // se digito nome nell'input searchText ritorna array filtrato con nome cercato
        if(this.searchText) {
        // converto lettere inserite nell'input in toLowerCase
